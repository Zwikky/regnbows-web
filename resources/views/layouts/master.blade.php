...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('/portal/img/logo.png')}}" type="image/x-icon">
...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-icon">
                    <img class="img-profile rounded-circle" src="{{asset('/portal/img/logo.png')}}" width="60"
                        height="60">
                </div>
                <div class="sidebar-brand-text mx-3">Regnbows</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePlaces" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('places')}}">Manage Places</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{asset('/portal/img/logo.png')}}" alt="">
                                        <div class="status-indicator bg-success"></div>
                                    </div>
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">Testing new arlet on level one.</div>
                                        <div class="small text-gray-500">Sizwe Dlamini · 58m</div>
                                    </div>
                                </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{asset(Auth::user()->imageUrl)}}">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    @if (count($errors) > 0)
                    <div class="alert alert-danger alert-dismissible fade show pl-3 pr-3">
                        <ul>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Regnbow Market {{date('Y')}}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="{{asset('/portal/js/demo/chart-area-demo.js')}}"></script>
    <script src="{{asset('/portal/js/demo/chart-pie-demo.js')}}"></script>
